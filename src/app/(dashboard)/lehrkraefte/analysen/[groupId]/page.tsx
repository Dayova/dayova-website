...
export default async function AnalyticsDetailPage({ params }: { params: Promise<{ groupId: string }> }) {
  ...
  return <><BackButton fallback="/lehrkraefte/analysen" /><PageHeading title={`${group.className} · ${group.subjectName}`} description="Wissensstand, Fehlvorstellungen und konkrete nächste Unterrichtsschritte." />
