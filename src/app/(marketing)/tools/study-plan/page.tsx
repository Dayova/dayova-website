...
const description = "Erstelle deinen kostenlosen Lernplan mit Fach, Themen, Termin und bis zu 4 Stunden Lernzeit pro Tag. Mit Theorie, Üben und Praxis – direkt druckbar.";
...
export default function StudyPlanPage() {
  return <div className="content-page study-plan-page">
    ...
    <PageHero eyebrow="Kostenloser Lernplan" title="Dein Fach. Dein Termin. Dein Lernplan." description="Wähle dein Fach und deinen Prüfungstag, beschreibe die Themen und lege deine tägliche Lernzeit fest. Dayova erstellt dir einen übersichtlichen Lernplan mit Theorie, Üben und Praxis – kostenlos und ohne Anmeldung." />
    <div className="dayova-container content-body">
      ...
      <ContentSection id="method" title="In drei Phasen zur Prüfung">
        ...
        <p>Dein Lernplan verteilt die Phasen von heute bis zum Tag vor deiner Prüfung. Deine tägliche Lernzeit legt den Zeitrahmen fest. Du entscheidest, wann du lernst und deine Pausen machst.</p>
      </ContentSection>
    ...
    <FaqAccordionSection id="questions" name="study-plan-faq" title="Fragen zum kostenlosen Lernplan" items={[
      { question: "Was brauche ich für meinen Lernplan?", answer: "Wähle dein Fach, deinen Prüfungstag ab morgen und 15 Minuten bis 4 Stunden Lernzeit pro Tag. Beschreibe kurz, welche Themen in deiner Arbeit vorkommen. Dein Lernplan startet automatisch heute und enthält die drei Phasen Theorie, Üben und Praxis." },
      ...
      { question: "Was bietet die Dayova-App zusätzlich?", answer: "Der Website-Plan gibt deinen beschriebenen Prüfungsthemen einen Zeitrahmen bis zur Prüfung. In der App kommen eine Wissensanalyse und Lernmaterial hinzu. Damit kann Dayova genauer einschätzen, welche Themen du noch lernen musst, und die Planung auf deinen Wissensstand abstimmen." },
    ]} />
  </div>;
}
