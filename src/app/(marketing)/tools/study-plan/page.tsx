  ...
  return <div className="content-page study-plan-page">
    ...
    <div className="dayova-container content-body">
      ...
      <ContentSection id="questions" title="Fragen zum kostenlosen Lernplan">
        ...
        <h3>Worin unterscheidet sich der Rechner von der Dayova-App?</h3><p>Der kostenlose Rechner verteilt deine eigenen Zeitschätzungen. Die App verbindet Prüfungsthemen und freie Zeiten mit Rückmeldungen aus deinen Antworten. <Link href="/features/study-planning">Lernplanung in der Dayova-App ansehen</Link>.</p>
      </ContentSection>
    </div>
  </div>;
}
