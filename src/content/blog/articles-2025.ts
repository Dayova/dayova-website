...
export const blogArticles2025: readonly BlogArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Feedback macht den Versuch nützlich",
        paragraphs: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Ein Rhythmus statt einer Nachtschicht",
        paragraphs: [
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Jede Prüfung misst unter bestimmten Bedingungen: ausgewählte Aufgaben, begrenzte Zeit und eine konkrete Form. Das Ergebnis enthält wertvolle Informationen, bildet aber nicht das gesamte Wissen oder Potenzial einer Person ab.",
          "Auch sehr gute Ergebnisse können Lücken verdecken, wenn vor allem bekannte Muster abgefragt wurden. Umgekehrt kann Stress vorhandenes Wissen in einer Prüfung schlechter zugänglich machen.",
        ],
      },
      {
        ...
        bullets: [
          ...
          "das Thema nach einigen Tagen erneut abrufen",
        ],
      },
      {
        title: "Noten als Hinweis nutzen",
        paragraphs: [
          "Lehrkräfte können Aufgabenarten und Denkwege im Feedback sichtbar machen. Eltern können nach dem Vorgehen fragen, ohne eine einzelne Zahl zum Gesamturteil zu machen.",
          "Dayova ergänzt Prüfungsergebnisse durch Antworten aus dem laufenden Lernen. Dadurch entsteht ein differenzierteres Bild davon, welche Inhalte stabil sind und wo weitere Anwendung gebraucht wird.",
        ],
      },
    ],
    takeaway:
  ...
  },
  {
    ...
    readingTime: "6 Min.",
    publishedAt: "17. November 2025",
    publishedAtISO: "2025-11-17T10:00:00+01:00",
    intro:
    ...
    sections: [
      {
        title: "Ein Vorsatz entscheidet noch nichts",
        paragraphs: [
  ...
  },
  {
    ...
    category: "Lernpsychologie",
    readingTime: "6 Min.",
    publishedAt: "10. November 2025",
    publishedAtISO: "2025-11-10T10:00:00+01:00",
    intro:
    ...
    sections: [
      {
        title: "Aufschieben reguliert Gefühle",
        paragraphs: [
      ...
      {
        title: "Den Einstieg kleiner machen",
        paragraphs: [
      ...
      {
        title: "Druck nicht mit Leistung verwechseln",
        paragraphs: [
  ...
  },
  {
    ...
    title: "Wenn Lernen nicht zur Note passt",
    excerpt:
      "Viel gelernt und trotzdem enttäuscht? Dann lohnt sich ein Blick auf Methode, Abruf und Aufgabenformat.",
    category: "Prüfungen",
    readingTime: "7 Min.",
    publishedAt: "3. November 2025",
    publishedAtISO: "2025-11-03T10:00:00+01:00",
    intro:
    ...
    sections: [
      {
        title: "Lernen kann am Abruf vorbeigehen",
        paragraphs: [
      ...
      {
        title: "Aus Enttäuschung einen nächsten Versuch machen",
        paragraphs: [
